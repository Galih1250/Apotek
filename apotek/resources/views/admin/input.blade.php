...
<main class="max-w-md mx-auto px-4 py-6">
  ...
  <div class="mb-4">
    <div id="preview"
         class="bg-gray-100 rounded-xl h-40 flex items-center justify-center text-slate-600">
      Preview Gambar
    </div>
  </div>
  ...
  <form method="POST"
    ...
    <div>
      ...
      <textarea name="description" rows="4"
                class="mt-1 w-full rounded-lg bg-gray-100 px-3 py-2">{{ old('description') }}</textarea>
    </div>

    <button type="submit"
            class="w-full rounded-full bg-red-600 text-white py-3 font-medium active:scale-95 hover:shadow-md">
      Simpan
    </button>
