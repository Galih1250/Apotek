...
<div class="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 p-4 flex flex-col h-full">
    ...
    <a href="{{ route('admin.products.edit', $product->id) }}" class="mt-auto w-full flex items-center justify-center gap-2 bg-red-600 text-white rounded-full py-2 transition-transform duration-200 active:scale-95 hover:shadow-md">
